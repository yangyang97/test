package com.repair.topImgController.service.impl;
...
@Service("topImgControllerService")
@Transactional
public class TopImgControllerServiceImpl extends CommonServiceImpl implements TopImgControllerServiceI {
