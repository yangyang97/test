                        ...
                        <div class="propj" style="padding:0;">
                            <form name="form1">
                                <select id="number" class="text" name="province" onclick="getCity()">
                                    ...
                                    <option value="369">IPhone X</option>
                                    <option value="389">IPhone X MAX</option>
                                    <option value="359">IPhone 8</option>
                                    <option value="339">IPhone 8plus</option>
                                    <option value="229">IPhone 7</option>
                                    <option value="239">IPhone 7 plus</option>
                                    <option value="169">IPhone 6s </option>
                                    <option value="169">IPhone 6s plus</option>
                                    <option value="159">IPhone 6 </option>
                                    <option value="159">IPhone 6 plus</option>
                                    <option value="129">IPhone 5</option>
                                    <option value="129">IPhone 5s</option>
                                </select>
