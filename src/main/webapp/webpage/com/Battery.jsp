...
<div class="webmain">
    ...
    <div class="nybg">
        ...
        <div class="nybanner" style="background:url(/plug-in/repair/images/battry.jpg) no-repeat center;"></div>
        <div class="blank25"></div>
        <div class="content">

            <div class="inright1">
                <div class="nylmtit"><a class="lmnav on">维修提交</a><div class="lj">您的位置：<a href="#">主页</a> > <a href="#">电池更换</a></div><div class="clean"></div></div>
                <div class="nycontact">
                    <div class="wz">
                        <h1 style="font-size:25px">电池更换：￥129元起</h1><br/>
                        ...
                        <div class="propj" style="padding:0;">
                            <form name="form1" class="applySpecialform">
                                <select id="number" class="text" name="province" onclick="getCity()">
                                    ...
                                    <option class="checkbox-type" tip="IPhone X" value="369">IPhone X</option>
                                    <option class="checkbox-type" tip="IPhone X MAX" value="399">IPhone X MAX</option>
                                    <option class="checkbox-type" tip="IPhone 8" value="359">IPhone 8</option>
                                    <option class="checkbox-type" tip="IPhone 8plus" value="329">IPhone 8plus</option>
                                    <option class="checkbox-type" tip="IPhone 7" value="269">IPhone 7</option>
                                    <option class="checkbox-type" tip="IPhone 7 plus" value="279">IPhone 7 plus</option>
                                    <option class="checkbox-type" tip="IPhone 6s" value="199">IPhone 6s </option>
                                    <option class="checkbox-type" tip="IPhone 6s plus" value="179">IPhone 6s plus</option>
                                    <option class="checkbox-type" tip="IPhone 6" value="159">IPhone 6 </option>
                                    <option class="checkbox-type" tip="IPhone 6 plus" value="159">IPhone 6 plus</option>
                                    <option class="checkbox-type" tip="IPhone 5" value="129">IPhone 5</option>
                                    <option class="checkbox-type" tip="IPhone 5s" value="129">IPhone 5s</option>
                                </select>
                            ...
                            <input value="立即提交" onclick="tuueueu(2)" class="sub">
