...
<div class="webmain">
    ...
    <div class="nybg">
        ...
        <div class="nybanner" style="background:url(/plug-in/repair/images/top.jpg) no-repeat center;"></div>
                        ...
                        <div class="propj" style="padding:0;">
                            <form name="form1" class="applySpecialform">
                                <select id="number" class="text" name="province" onclick="getCity()">
                                    ...
                                    <option class="checkbox-type" tip="IPhone X" value="459">IPhone X</option>
                                    <option class="checkbox-type" tip="IPhone X MAX" value="499">IPhone X MAX</option>
                                    <option class="checkbox-type" tip="IPhone 8" value="365">IPhone 8</option>
                                    <option class="checkbox-type" tip="IPhone 8plus" value="399">IPhone 8plus</option>
                                    <option class="checkbox-type" tip="IPhone 7" value="229">IPhone 7</option>
                                    <option class="checkbox-type" tip="IPhone 7 plus" value="339">IPhone 7 plus</option>
                                    <option class="checkbox-type" tip="IPhone 6s" value="199">IPhone 6s </option>
                                    <option class="checkbox-type" tip="IPhone 6s plus" value="299">IPhone 6s plus</option>
                                    <option class="checkbox-type" tip="IPhone 6" value="179">IPhone 6 </option>
                               ...
                               <h1 style="color:red ; font-size:20px">您应付款：￥<input style="color:red ; font-size:20px" id="tax1" type="text" value="0"></h1>
                                ...
                                <input value="立即提交" onclick="tuueueu(1)" class="sub">
